...
# DATASET_EVAL_CROP_SIZE=$IMATERIALIST_EVAL_CROP_SIZE
...
# DATASET_EVAL_CROP_SIZE=$HUMANPARSING_EVAL_CROP_SIZE
...
# DATASET_EVAL_CROP_SIZE=$FORMA_EVAL_CROP_SIZE
...
# DATASET_NAME=$NSFW_DATASET_NAME
# DATASET_EVAL_CROP_SIZE=$NSFW_EVAL_CROP_SIZE
# DATASET_TRAIN_SIZE=$NSFW_DATASET_TRAIN_SIZE
# DATASET_DIR=$NSFW_DATASET_DIR
# DATASET_TFRECORD=$NSFW_DATASET_TFRECORD
# DATASET_SPLIT=$NSFW_DATASET_SPLIT

DATASET_NAME=$FORMA55K_DATASET_NAME
DATASET_EVAL_CROP_SIZE=$FORMA55K_EVAL_CROP_SIZE
DATASET_TRAIN_SIZE=$FORMA55K_DATASET_TRAIN_SIZE
DATASET_DIR=$FORMA55K_DATASET_DIR
DATASET_TFRECORD=$FORMA55K_DATASET_TFRECORD
DATASET_SPLIT=$FORMA55K_DATASET_SPLIT
